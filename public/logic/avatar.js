AFRAME.registerComponent("avatar", {
    init: function () {
        ...
        const headMaterial = new THREE.MeshStandardMaterial({ color: "orange" });
        ...
        const torsoMaterial = new THREE.MeshStandardMaterial({ color: "blue" });
        ...
        const rArmMaterial = new THREE.MeshStandardMaterial({ color: "orange" });
        ...
        const lArmMaterial = new THREE.MeshStandardMaterial({ color: "orange" });
        ...
        const rLegMaterial = new THREE.MeshStandardMaterial({ color: "orange" });
        ...
        const lLegMaterial = new THREE.MeshStandardMaterial({ color: "orange" });
